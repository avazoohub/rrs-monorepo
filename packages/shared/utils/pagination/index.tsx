...
export const PaginatedList = ({
  ...
  const selectItem = (item: any) => {
    ...
    answer?.questionNumber === 7 && _setSelectedTeam(item.team.id);
  };
      ...
      >
        {currentItems.map((item: any, index: any) => (
          <li
            ...
            style={{ borderBottom: "0.1rem solid rgb(49, 46, 58)" }}
          >
            <button
            ...
            >
              <div className="flex flex-col items-start w-full">
                  ...
                  <div className="flex items-center justify-start space-x-4 text-left cursor-pointer w-full px-4 py-2">
                    ...
                    <div>
                      ...
                      <p className="font-light flex items-center space-x-2">
                        <span
                          className="flex items-center justify-between space-x-3 font-light opacity-50 mt-1"
                          style={{
                            fontWeight: "300",
                            display: "flex",
                          }}
                ...
                {(answer?.questionNumber === 3 ||
                  ...
                  <p className="text-left px-6 py-4 w-full">{item.name}</p>
                )}{" "}
                {answer?.questionNumber === 7 && (
                  <p
                    className="text-left font-light px-2 py-1 w-full rounded-md"
                    style={{
                      color: "#c4bfd0",
                      borderRadius: "10px",
                      padding: "5px 4px",
