...
export default function Sidebar() {
    ...
    return (
        <>
            <TopBar />
            <aside className={`fixed md:static bottom-0 left-0 right-0 z-[99] md:z-[1] h-[50%] w-full md:w-2/12 h-full overflow-y-auto py-6 md:py-0 px-2 md:rounded-2xl bg-[#0c0813] md:bg-transparent transition ${isOpen ? 'translate-y-[0]' : 'translate-y-[100%] md:translate-y-[0]'}`}>
