...
export default function Apps() {
    return (
        <div className=" bg-[#110e19] rounded-2xl p-8">
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-4 lg:gap-x-2 gap-y-3 lg:gap-y-4 mt-8">
                <App img="https://jellyfish-app-37fxs.ondigitalocean.app/_next/image?url=%2Fapps%2Fmatchit.png&w=256&q=75" label="MatchIt" />
